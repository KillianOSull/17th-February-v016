	...
	if (services.includes(codeServiceOfInterestUuid)) { //code Services
  	...
  	if (services.includes(buttonServiceOfInterestUuid)) { //Button Services
	 	...
	 	buttonAChar.on('valuechanged', async BtnA => {
	 		...
	 		console.log('Unlock Counter value: ' + unlock_counter_val_str)
	 		...
	 		console.log('interget counter: ' + unlock_counter_val_int)
	 		...
	 		process.stdout.write('The Unlock Code is: ') //code sent is as ABCDEFGH... code recieved as GHEFCDAB because of big and little endians 
